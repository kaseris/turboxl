...
<Override PartName="/xl/sharedStrings.xml" ContentType="application/vnd.openxmlformats-officedocument.spreadsheetml.sharedStrings+xml"/>
        ...
        'xl/workbook.xml': f'<workbook xmlns="{main}" xmlns:r="{rel}"><sheets><sheet name="Chart" sheetId="1" r:id="rId1"/><sheet name="Data" sheetId="2" r:id="rId2"/><sheet name="Hidden" sheetId="3" state="hidden" r:id="rId3"/><sheet name="VeryHidden" sheetId="4" state="veryHidden" r:id="rId4"/><sheet name="Dialog" sheetId="5" r:id="rId5"/><sheet name="Sparse" sheetId="6" r:id="rId6"/></sheets></workbook>',
